package ba.unsa.fsk.picerija.fragments;
...
import ba.unsa.fsk.picerija.R;
import ba.unsa.fsk.picerija.data.Pizza;
...
public class PizzaDetailFragment extends Fragment {
  ...
  public void updateView( int position){
    Toast.makeText(getContext(), "Called By Fragment B: position - "+ position, Toast.LENGTH_SHORT).show();
